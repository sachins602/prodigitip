      ...
      <div className="flex flex-wrap">
        {ServiceItems.map((item, index) => (
          <div className="w-full px-4 md:w-1/2 lg:w-1/3" key={index}>
            <div className="mb-8 h-80 rounded-[20px] bg-white p-10 shadow-md hover:shadow-lg dark:bg-gray-700 md:px-7 xl:px-10">
              <div className="mb-8 mx-auto flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-blue-500">
                <Image
                  width={60}
                  height={60}
                  src={item.image}
